...
if (!analysisFile || !fs.existsSync(analysisFile)) {
  console.error('❌ Error: Analysis file required and must exist');
...
## 🏷️ Topics
${data.analysis?.topics?.map(t => `- #${t}`).join('\n') || '- No topics tagged.'}

---

*Generated by Podcast → Notes Skill*
`;
